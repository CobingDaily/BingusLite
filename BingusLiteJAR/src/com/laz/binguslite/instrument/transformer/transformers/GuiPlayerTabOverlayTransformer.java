...
public class GuiPlayerTabOverlayTransformer implements Transformer {
    ...
    private InsnList finalsInTab(int networkPlayerInfoIndex) {
        ...
        insnList.add(new MethodInsnNode(INVOKEVIRTUAL, "com/laz/binguslite/BingusLite", "getChatMessageParser", "()Lcom/laz/binguslite/finalscounter/ChatMessageParser;", false));
        ...
        insnList.add(new MethodInsnNode(INVOKEVIRTUAL, "com/laz/binguslite/finalscounter/ChatMessageParser", "getFinalsInTabString", "(Ljava/lang/String;)Ljava/lang/String;", false));
