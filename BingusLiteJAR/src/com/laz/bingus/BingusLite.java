...
import com.laz.bingus.command.CommandManager;
import com.laz.bingus.finalscounter.ChatMessageParser;
import com.laz.bingus.finalscounter.FinalsCounterRenderer;
import com.laz.bingus.instrument.Instrumentation;
import com.laz.bingus.instrument.transformer.transformers.EntityPlayerSPTransformer;
import com.laz.bingus.instrument.transformer.transformers.GuiNewChatTransformer;
import com.laz.bingus.instrument.transformer.transformers.GuiPlayerTabOverlayTransformer;
import com.laz.bingus.instrument.transformer.transformers.MinecraftTransformer;
import com.laz.bingus.mapping.Mapping;
import com.laz.bingus.mapping.mappings.Lunar;
import com.laz.bingus.mapping.mappings.Vanilla;
...
public class BingusLite {
    public static BingusLite instance;
    ...
    public boolean initialize(Client client, ClassLoader classLoader, String workingDirectory) {
        configFile = new File(workingDirectory, "BingusLite.json");
